...
var _searchMobileView = __webpack_require__(135);
...
function searchMobile_reducers(state, action) {
  if (state === undefined) {
    var history = getSearchHistory(localStorage.getItem('searchHistory'));
    console.log(history);
    state = {
      value: '',
      history: history
  ...
  switch (action.type) {
    case 'submit':
      if (isLocalStorage) {
        ...
        if (_history === '') {
          _history = state.value;
        } else {
          _history += '&' + state.value;
        }
        localStorage.setItem('searchHistory', _history);
      }
      return state;
      break;
    case 'inputValue':
...
var App = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_searchMobileView.Blue_Container);
...
var _searchMobile = __webpack_require__(128);
...
function scrollChange() {
    ...
    tid = setTimeout(function () {
        scrollW = (0, _ajax.getScreenSize)().width;
        _searchMobile2.default.dispatch(createAction('scrollChange', {
...
//  </div>
// 顶部
var Blue_Top = function (_React$Component) {
  _inherits(Blue_Top, _React$Component);
...
var Blue_SearchMobile = function (_React$Component2) {
  _inherits(Blue_SearchMobile, _React$Component2);

  function Blue_SearchMobile() {
    _classCallCheck(this, Blue_SearchMobile);

    return _possibleConstructorReturn(this, (Blue_SearchMobile.__proto__ || Object.getPrototypeOf(Blue_SearchMobile)).apply(this, arguments));
  }

  _createClass(Blue_SearchMobile, [{
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "Blue_SearchMobile" },
        _react2.default.createElement(
          "div",
          { className: "inputWarp" },
          _react2.default.createElement("input", { onInput: input }),
        ...
        _react2.default.createElement(
          ...
          history.length > 0 ? _react2.default.createElement(
            "div",
            null,
            _react2.default.createElement("button", { className: "empty", onClick: empty }),
            _react2.default.createElement(
              "p",
              { className: "emptyWarn" },
              "\u6E05\u7A7A\u8BB0\u5F55"
  ...
  _createClass(Blue_Container, [{
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          searchDispatch = _props3.searchDispatch;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Blue_SearchMobile, _extends({}, searchState, searchDispatch))
      );
    }
  }]);
