...
function updateRem(width, dpr) {
  ...
  if (width * appConfig.scale <= 768) appConfig.isMobile = true;
}
...
function getImgURL(url, size) {
  var suffixStart = url.lastIndexOf('.', url.length),
      ...
      newURL = void 0;
  if (size) newURL = imgURL + size + suffix + '?sign=iqiyi';else newURL = imgURL + appConfig.imgSzie + suffix + '?sign=iqiyi';
  return newURL;
}
module.exports = {
  config: appConfig,
...
var _searchMobileView = __webpack_require__(139);

var _public = __webpack_require__(7);
...
function searchMobile_reducers(state, action) {
  ...
  switch (action.type) {
    case 'init':
      var curHistory = localStorage.getItem('searchHistory'),
          myhistory = getSearchHistory(curHistory),
          content = action.content;
      if (content) action.ajaxSearch(content, curHistory);
      return (0, _public.assign)({}, state, {
        myhistory: myhistory || [],
    ...
    case 'submit':
      if (isLocalStorage) {
        var _value = state.value,
            _myhistory = setSearchHistory(_value, state.myhistory),
            _newURL = 'searchMobile.html?content=' + _value;
        history.pushState({}, '', _newURL);
        state.ajaxSearch(_value, _myhistory);
      }
      return (0, _public.assign)({}, state, {
        isSearching: true,
        isShow: false
  ...
  return {
    searchDispatch: {
      ...
      keyPress: function keyPress(e) {
        if (e.charCode == 13) dispatch({ type: 'submit' });
      },
      ...
      clickHistory: function clickHistory(value) {
...
var _ajaxExpandMiniMin = __webpack_require__(13);

var _public = __webpack_require__(7);

var _searchMobile = __webpack_require__(129);
...
// 全局常量
var win = window,
    host = _public.config.host,
    searchURL = host + '/openapi/realtime/search',
    publicData = _public.config.publicData;
...
**/
var tid = void 0,
    scrollW = (0, _public.getScreenSize)().width;
...
// 搜索组件逻辑控制
(function (win, doc) {
  var query = (0, _public.parseURLQuery)(win.location.href),
  ...
  _searchMobile2.default.dispatch(createAction('init', {
  ...
  win.addEventListener('scroll', function (e) {
    ...
    // 显示置顶按钮
    if (scrollTop > 700) {
      _searchMobile2.default.dispatch(createAction('showTop', {
        showTop: true
      }));
    } else {
      _searchMobile2.default.dispatch(createAction('showTop', {
    ...
    if (toBottom >= -10) {
      ...
      if (!preToBottom || preToBottom < toBottom) {
        ...
        if (isAjaxing) {
          _searchMobile2.default.dispatch(createAction('updateing', {
            isUpdateing: true
          }));
  ...
  function ajaxSearch(searchContent, myhistory, update) {
    ...
    _ajaxExpandMiniMin.ajaxExpanding.init({
      ...
      onSuccess: function onSuccess(result) {
        if (update) _searchMobile2.default.dispatch(createAction('updateing', {
          isUpdateing: false
        }));
        ...
        if (code === 100000) {
          for (i = 0, len = data.length; i < len; i++) {
            items.push({
              title: (0, _public.getlimitStr)(data[i].short_title, limitLen),
              score: data[i].sns_score,
              img: (0, _public.getImgURL)(data[i].img, '_180_236')
            });
          }
          if (myhistory) localStorage.setItem('searchHistory', myhistory);
        } else {
        ...
        _searchMobile2.default.dispatch(createAction(update ? 'updateResult' : 'getSearchResult', {
          items: items,
          desc: desc
        }));
      },
...
// 评分组件
var Blue_Score = function (_React$Component) {
  _inherits(Blue_Score, _React$Component);

  function Blue_Score() {
    _classCallCheck(this, Blue_Score);

    return _possibleConstructorReturn(this, (Blue_Score.__proto__ || Object.getPrototypeOf(Blue_Score)).apply(this, arguments));
  }

  _createClass(Blue_Score, [{
    key: '_createStar',
    value: function _createStar(startNum, sum) {
      var i = void 0,
          len = void 0,
          starList = [];
      if (startNum > sum) startNum = sum;
      for (i = 0, len = sum; i < len; i++) {
        starList.push(_react2.default.createElement('span', { className: i < startNum ? 'star onstar' : 'star nostar',
          key: i,
          'data-key': i }));
      }
      return starList;
...
var Blue_Top = function (_React$Component2) {
  ...
  _createClass(Blue_Top, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'Blue_Top fontSizeM maxWarp' },
        _react2.default.createElement(
          'a',
          { href: '../index.html' },
...
var Blue_SearchCard = function (_React$Component3) {
  _inherits(Blue_SearchCard, _React$Component3);

  function Blue_SearchCard() {
    _classCallCheck(this, Blue_SearchCard);

    return _possibleConstructorReturn(this, (Blue_SearchCard.__proto__ || Object.getPrototypeOf(Blue_SearchCard)).apply(this, arguments));
  }

  _createClass(Blue_SearchCard, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'Blue_SearchCard' },
        _react2.default.createElement('img', { src: img }),
        _react2.default.createElement(
          'div',
          { className: 'desc fontSizeL' },
          _react2.default.createElement(
            'span',
            { className: 'name' },
            title
          ),
          _react2.default.createElement(Blue_Score, { score: +score || 0 })
        )
      );
    }
  }]);

  return Blue_SearchCard;
}(_react2.default.Component);
// 移动端搜索组件


var Blue_SearchMobile = function (_React$Component4) {
  _inherits(Blue_SearchMobile, _React$Component4);
  ...
  _createClass(Blue_SearchMobile, [{
    key: '_creatCards',
    value: function _creatCards(items, desc) {
      var i = void 0,
          len = items.length,
          result = [];
      if (len === 0) {
        result.push(_react2.default.createElement(
          'p',
          { className: 'searching fontSizeM', key: 0 },
          desc
        ));
      } else {
        for (i = 0; i < len; i++) {
          result.push(_react2.default.createElement(Blue_SearchCard, { key: i, item: items[i] }));
        }
      }
      return result;
    }
    ...
    key: '_clickHistory',
    value: function _clickHistory(value) {
      var that = this;
      return function () {
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          myhistory = _props2.myhistory,
          empty = _props2.empty,
          isShow = _props2.isShow,
          items = _props2.items,
          desc = _props2.desc,
          value = _props2.value,
          keyPress = _props2.keyPress,
          isSearching = _props2.isSearching,
          isUpdateing = _props2.isUpdateing,
          that = this;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'inputWarp maxWarp' },
            _react2.default.createElement('input', { className: 'fontSizeL', value: value, onInput: input, onKeyPress: keyPress }),
            _react2.default.createElement('button', { onClick: search })
          )
        ),
        isShow && !isSearching && _react2.default.createElement(
          'div',
          { className: 'myHistory' },
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              'ul',
              null,
              myhistory.map(function (value, index) {
                return _react2.default.createElement(
                  'li',
                  { key: index,
            ...
            myhistory.length > 0 ? _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement('button', { className: 'empty', onClick: empty }),
              _react2.default.createElement(
                'p',
                { className: 'emptyWarn fontSizeSS' },
                '\u6E05\u7A7A\u8BB0\u5F55'
              )
            ) : _react2.default.createElement(
              'p',
        ...
        isUpdateing && _react2.default.createElement(
          'div',
          { className: 'searching', style: { marginTop: 0 } },
          _react2.default.createElement('img', { className: 'searchImg', src: _public.config.ourHost + "/resource/images/" + 'loading.gif' }),
          _react2.default.createElement(
            'p',
            { className: 'fontSizeM' },
            '\u6B63\u5728\u52A0\u8F09\u4E2D....'
...
var Blue_PT_LI = function (_React$Component5) {
  _inherits(Blue_PT_LI, _React$Component5);

  function Blue_PT_LI() {
    _classCallCheck(this, Blue_PT_LI);

    return _possibleConstructorReturn(this, (Blue_PT_LI.__proto__ || Object.getPrototypeOf(Blue_PT_LI)).apply(this, arguments));
  }

  _createClass(Blue_PT_LI, [{
    key: '_create',
...
var Blue_PT = function (_React$Component6) {
  _inherits(Blue_PT, _React$Component6);

  function Blue_PT() {
    _classCallCheck(this, Blue_PT);

    return _possibleConstructorReturn(this, (Blue_PT.__proto__ || Object.getPrototypeOf(Blue_PT)).apply(this, arguments));
  }

  _createClass(Blue_PT, [{
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        sum > 1 && _react2.default.createElement(
          'div',
          { id: 'turnPageWarp' },
          _react2.default.createElement(
            'div',
            { className: "BluMUI_PT" },
            _react2.default.createElement('button', { id: 'lastPage', onClick: last, className: 'last' }),
            _react2.default.createElement(Blue_PT_LI, { sum: sum,
              click: click,
              showNum: showNum,
              index: index,
              start: start
            }),
            _react2.default.createElement('button', { id: 'nextPage', onClick: next, className: 'next' })
          )
        )
      );
    }
...
var Blue_Container = function (_React$Component7) {
  _inherits(Blue_Container, _React$Component7);
  ...
  _createClass(Blue_Container, [{
    ...
    value: function render() {
      var _props5 = this.props,
          searchState = _props5.searchState,
          PtState = _props5.PtState,
          searchDispatch = _props5.searchDispatch;
      ...
      return _react2.default.createElement(
        ...
        searchState.showTop && _react2.default.createElement('button', { className: 'backTopBtn', onClick: searchDispatch.toTop })
      );
    }
  }]);
