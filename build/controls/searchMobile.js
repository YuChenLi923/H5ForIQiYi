...
(function () {
  var win = window,
      query = (0, _ajax.parseURLQuery)(window.location.href),
      ...
      onSuccess: function onSuccess(result) {
        ...
        if (code === 100000) {
          for (i = 0, len = data.length; i < len; i++) {
            items.push({
              title: (0, _ajax.getlimitStr)(data[i].short_title, 10),
        ...
        _searchMobile2.default.dispatch(createAction('getSearchResult', {
          items: items,
          desc: desc
        }));
      },
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'inputWarp' },
          _react2.default.createElement('input', { className: 'fontSizeL', value: value, onInput: input }),
