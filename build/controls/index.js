...
var _indexView = __webpack_require__(136);
...
function NavList_reducers() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { items: [], index: 0, isIndexHtml: true };
  var action = arguments[1];
...
function Carousel_reducers(state, action) {
  ...
  switch (action.type) {
    ...
    case 'touchChangeIndex':
      var dir = (0, _public.getTouchDirection)(state.startX, state.startY, action.x, action.y),
          changeIndex = 0,
          Index = void 0;
      if (dir == 2) {
        changeIndex = -1;
...
(function () {
  ...
  _ajaxExpandMiniMin.ajaxExpanding.init({
    ...
    onFail: function onFail() {
      if (this.data.req_times > 3) _index2.default.dispatch(createAction('loadFail'));else {
...
function setCarousel(data) {
  ...
  for (i = 0; i < len; i++) {
    items.push({
      src: '#',
      img: videos[i].img,
      title: (0, _public.getlimitStr)(videos[i].short_title, 15, '...')
    });
  }
...
function setCardInf(data, type) {
  ...
  for (i = 0; i < len; i++) {
    item = {
      src: '#',
      img: (0, _public.getImgURL)(videos[i].img),
      title: (0, _public.getlimitStr)(videos[i].short_title, 10)
    };
    if (type === '综艺') {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'list maxWarp', style: { height: isOn ? Math.ceil(len / showLen) * 0.5 + 'rem' : 0.5 + 'rem' } },
        ...
        len > 0 ? _react2.default.createElement(
          ...
          { className: 'body',
            style: {
              ...
              width: len * width + 'px' } },
          bodyShow
        ) : _react2.default.createElement(Blue_Loading, { text: '\u6B63\u5728\u52A0\u8F7D\u5185\u5BB9' }),
        _react2.default.createElement(
          'div',
          { className: len > 0 ? 'nav' : '' },
          _react2.default.createElement(
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: 'title fontSizeL', style: { backgroundImage: 'url(' + _public.config.ourHost + '/resource/images/title-' + card.id + '.png)' } },
            card.title
          ),
          _react2.default.createElement(
            'span',
            { className: 'more fontSizeL', onClick: this.goto(card.id) },
            '\u66F4\u591A'
          )
        ),
        _react2.default.createElement(
...
var Blue_Loading = function (_React$Component4) {
  ...
  function Blue_Loading(props) {
    ...
    var _this4 = _possibleConstructorReturn(this, (Blue_Loading.__proto__ || Object.getPrototypeOf(Blue_Loading)).call(this, props));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: 'pages/rank.html' },
            _react2.default.createElement(
              'span',
              { className: 'fontSizeSS rank' },
              '\u6392\u884C\u699C'
            )
          )
        )
