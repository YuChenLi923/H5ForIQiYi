...
var _rankView = __webpack_require__(138);
  ...
  return {
    topDisPatch: {
      search: function search() {
        var isMobile = _public.config.isMobile;
        if (isMobile) {
...
var App = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_rankView.Blue_Container);
...
var _rank = __webpack_require__(128);
...
function scrollChange() {
    ...
    tid = setTimeout(function () {
        scrollW = (0, _public.getScreenSize)().width;
        _rank2.default.dispatch(createAction('scrollChange', {
            showLen: scrollW > 768 ? 10 : 4,
            width: scrollW <= 1180 ? scrollW / _public.config.scale : 1180,
            height: scrollW > 1180 ? 316 / 640 * 1180 : 316 / 640 * scrollW / _public.config.scale
        }));
    }, 300);
}
...
var Rank_lists = function (_React$Component2) {
  _inherits(Rank_lists, _React$Component2);

  function Rank_lists(props) {
    _classCallCheck(this, Rank_lists);

    var _this2 = _possibleConstructorReturn(this, (Rank_lists.__proto__ || Object.getPrototypeOf(Rank_lists)).call(this, props));

    _this2.isMobile = (0, _public.getScreenSize)().width < 768;
    _this2.state = {
      datas: [],
      nodata: 1
    };
  ...
  _createClass(Rank_lists, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      var _this3 = this;

      var send_data = _public.config.publicData;
      _ajaxExpandMiniMin.ajaxExpanding.init({
        url: _public.config.host + '/openapi/realtime/recommend',
        data: send_data,
        dataType: 'json',
        type: 'get',
        async: true,
        ...
        onSuccess: function onSuccess(result) {
          var Ranks = [];
          result.data.map(function (e, index) {
            if (index > 0) Ranks = Ranks.concat(e.video_list);
          });
          _this3.setState({
            nodata: 0,
            datas: Ranks
    ...
    value: function render() {
      ...
      if (this.state.nodata) {
        console.log('a');
        return _react2.default.createElement(Blue_Loading, { text: '\u6B63\u5728\u52A0\u8F7D' });
      } else {
        console.log("b");
        if (this.isMobile) {
          console.log('c');
          return _react2.default.createElement(
            'div',
            { id: 'phone_ranks', className: 'maxWarp' },
            this.state.datas.map(function (e, index) {
              return _react2.default.createElement(
                'div',
                { className: 'rank_item', key: index },
...
var _Rank_lists = __webpack_require__(134);

var _Rank_lists2 = _interopRequireDefault(_Rank_lists);
...
var Blue_Container = function (_React$Component3) {
  ...
  _createClass(Blue_Container, [{
    key: 'render',
    value: function render() {
      var topDisPatch = this.props.topDisPatch;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'body' },
          _react2.default.createElement(_Rank_lists2.default, null)
        ),
        _react2.default.createElement(
          'footer',
          { className: 'fontSizeSS' },
