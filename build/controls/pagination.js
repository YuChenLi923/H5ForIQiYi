...
function Detail_reducers() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { nodata: 0, videos: [] };
  var action = arguments[1];
  ...
  switch (action.type) {
    ...
    case 'clickItem':
      ...
      break;
    case 'newDetails':
      if (action.datas.code == 100000) return Object.assign({}, state, {
        nodata: 0,
...
function getDetail(name) {
  // 请求详细信息ajax
  // 设置本次请求的data
  var zq_data = _ajax.config.publicData;
  zq_data.type = 'detail';
  zq_data.version = 7.5;
  zq_data.mode = 11;
  ...
  _ajaxExpandMiniMin.ajaxExpanding.send({
    url: _ajax.config.host + '/openapi/realtime/channel',
    data: zq_data,
    onSuccess: function onSuccess(result) {
...
var Page_body = function (_React$Component) {
  ...
  function Page_body(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Page_body.__proto__ || Object.getPrototypeOf(Page_body)).call(this, props));
  ...
  _createClass(Page_body, [{
      ...
      if (this.props.nodata) {
        ...
        this.props.videos.map(function (e, index) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement('img', { src: (0, _ajax.getImgURL)(e.img), alt: e.title }),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: { background: 'yellow' }, id: 'zq_body' },
        this.create_body()
      );
    }
  }]);
